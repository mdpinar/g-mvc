 ...
 * 
 */
public class IncomingMovieBrowser extends AbstractBrowser<IncomingMovieDTO> {

	public IncomingMovieBrowser(IController<IncomingMovieDTO> controller) {
		super(controller);
	}
