...
/**
 * Lokasyon/Bolge Tanitimi, Browser sinifi
 * 
 * @see AbstractBrowser
 * 
 * @author mdpinar
 * 
 */
public class LocationBrowser extends AbstractBrowser<LocationDTO> {

	public LocationBrowser(IController<LocationDTO> controller) {
