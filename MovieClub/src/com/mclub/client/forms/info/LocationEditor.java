...
/**
 * Lokasyon/Bolge Tanitimi, Editor sinifi
 * 
 * @see AbstractEditor
 * 
 * @author mdpinar
 * 
 */
public class LocationEditor extends AbstractEditor<LocationDTO> {
	...
	public LocationEditor(IController<LocationDTO> controller) {
		super(controller);
	}
	 ...
	 */
	@Override
	public LocationDTO getNewModel() {
