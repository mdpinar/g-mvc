...
/**
 * Durumu degisien filmler, Browser sinifi
 * 
 * @see AbstractBrowser
 * 
 * @author mdpinar
 * 
 */
public class ChangeStatusBrowser extends AbstractBrowser<ChangeStatusDTO> {

	public ChangeStatusBrowser(IController<ChangeStatusDTO> controller) {
		super(controller);
	}
	...
	public ColumnFactory getColumnFactory() {
		return 
			new ColumnFactory()
				...
				.addColumn("description", Tags.get("description"), 200, true, SearchType.LIKE, true)
	...
	public String getDeleteQueryPart() {
		return getSelectedModel().getDescription();
	}
