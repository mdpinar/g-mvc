...
/**
 * Kullanici Tanitimi altindaki Form Rolleri kismi, Controller sinifi
 * 
 ...
 * 
 */
public class FormRolesMiniController extends AbstractMiniController<RoleDTO> {
	...
	public FormRolesMiniController(IController<?> parent) {
		super(parent, "Role");
	}
	...
	public IBrowser<RoleDTO> createBrowser() {
		return new FormRolesMiniBrowser(this);
	}
