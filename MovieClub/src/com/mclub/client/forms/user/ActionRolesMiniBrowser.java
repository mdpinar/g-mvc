...
/**
 * Kullanici Tanitimi altindaki Aksiyon Form Rolleri kismi, Browser sinifi
 * 
 * @see AbstractBrowser
 * 
 * @author mdpinar
 * 
 */
public class ActionRolesMiniBrowser extends AbstractBrowser<RoleDTO> {

	public ActionRolesMiniBrowser(IController<RoleDTO> controller) {
		super(controller);
	}
	...
	public ColumnFactory getColumnFactory() {
		return
			new ColumnFactory()
				.addColumn("right", Tags.get("rights"), 210)
				.addColumn(ColumnFactory.getCheckBoxColumn("hasAddNew", Tags.get("hasAddNew"), 60))
				.addColumn(ColumnFactory.getCheckBoxColumn("hasRead", Tags.get("hasRead"), 60))
				.addColumn(ColumnFactory.getCheckBoxColumn("hasUpdate", Tags.get("hasUpdate"), 60))
				.addColumn(ColumnFactory.getCheckBoxColumn("hasDelete", Tags.get("hasDelete"), 60));
	}
