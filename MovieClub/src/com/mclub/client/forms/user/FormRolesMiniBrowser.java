...
/**
 * Kullanici Tanitimi altindaki Form Rolleri kismi, Browser sinifi
 * 
 * @see AbstractBrowser
 * 
 * @author mdpinar
 * 
 */
public class FormRolesMiniBrowser extends AbstractBrowser<RoleDTO> {

	public FormRolesMiniBrowser(IController<RoleDTO> controller) {
		super(controller);
	}
