 ...
 * 
 */
public class MovieReportView extends AbstractReportView {
	...
	public MovieReportView(IReportController controller) {
		super(controller);
	}
	...
	public String getQueryString() {
		...
		if (name.getValue() != null && ! name.getValue().equals("")) {
			queryBuilder.append(" and m.name >= '");
